...
public class DlnaEventManager : IDlnaEventManager
{
    ...
    public EventSubscriptionResponse RenewEventSubscription(string? subscriptionId, string? notificationType, string? requestedTimeoutString, string? callbackUrl)
    {
        ...
        if (subscription is not null && subscriptionId is not null)
        {
            ...
            _logger.LogDebug(
                "Renewing event subscription for {NotificationType} with timeout of {Timout} to {CallbackUrl}",
    ...
    public EventSubscriptionResponse CreateEventSubscription(string? notificationType, string? requestedTimeoutString, string? callbackUrl)
    {
        ...
        _logger.LogDebug(
            "Creating event subscription for {NotificationType} with timeout of {Timeout} to {CallbackUrl}",
            notificationType,
            timeout,
            callbackUrl);
